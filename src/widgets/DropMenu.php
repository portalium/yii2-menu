...
class DropMenu extends Widget
{
    ...
    protected function renderItem($item)
    {
        ...
        $html .= Html::tag('button', '<i class="fa fa-arrow-circle-right"></i>', ['class' => 'btn btn-sm btn-primary btn-move move-item', 'name' => "move-item", 'style' => ' float:right; overflow: hidden; width: 25px; height: 19px; margin-right: 5px; padding:0px 6px;', 'data' => $item['id'], 'id_menu' => $this->id_menu]);
